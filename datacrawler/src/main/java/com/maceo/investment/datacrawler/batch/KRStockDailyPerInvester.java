...
@Component
public class KRStockDailyPerInvester {

    private static final String NAVER_DAILY_MARKET_PRICE_URL = "http://http://finance.naver.com/item/frgn.nhn?code=#{stockCode}&page=#{pageNum}";
    private static int MAX_ENTRY_SIZE_PER_PAGE = 20;
...
//                    try {
//                        crawlResult = crawlPerInvester(stock.getStockCode(), lastCrawlDate);
...
//                    });
//                });
        crawlPerInvester("069500", DateTime.now().minusMonths(1));
    }

    public static List<StockDailyData> crawlPerInvester(String stockCode, DateTime lastCrawlDate) throws InterruptedException {
        Integer pageNum = 1;
