...
public class KRFinancialSheetNaverCrawler {
    ...
    static {
        ...
        rowIndexTermMap.putIfAbsent(4, "영업이익(발표기준)");
        rowIndexTermMap.putIfAbsent(5, "세전계속사업이익");
        rowIndexTermMap.putIfAbsent(6, "당기순이익");
        rowIndexTermMap.putIfAbsent(7, "당기순이익(지배)");
        rowIndexTermMap.putIfAbsent(8, "당기순이익(비지배)");
        rowIndexTermMap.putIfAbsent(9, "자산총계");
        rowIndexTermMap.putIfAbsent(10, "부채총계");
        rowIndexTermMap.putIfAbsent(11, "자본총계");
        rowIndexTermMap.putIfAbsent(12, "자본총계(지배)");
        rowIndexTermMap.putIfAbsent(13, "자본총계(비지배)");
        rowIndexTermMap.putIfAbsent(14, "자본금");
        rowIndexTermMap.putIfAbsent(15, "영업활동현금흐름");
        rowIndexTermMap.putIfAbsent(16, "투자활동현금흐름");
        rowIndexTermMap.putIfAbsent(17, "재무활동현금흐름");
        rowIndexTermMap.putIfAbsent(18, "CAPEX");
        rowIndexTermMap.putIfAbsent(19, "FCF");
        rowIndexTermMap.putIfAbsent(20, "이자발생부채");
        rowIndexTermMap.putIfAbsent(21, "영업이익률");
        rowIndexTermMap.putIfAbsent(22, "순이익률");
        rowIndexTermMap.putIfAbsent(23, "ROE(%)");
        rowIndexTermMap.putIfAbsent(24, "ROA(%)");
        rowIndexTermMap.putIfAbsent(25, "부채비율");
        rowIndexTermMap.putIfAbsent(26, "자본유보율");
        rowIndexTermMap.putIfAbsent(27, "EPS(원)");
        rowIndexTermMap.putIfAbsent(28, "PER(배)");
        rowIndexTermMap.putIfAbsent(29, "BPS(원)");
        rowIndexTermMap.putIfAbsent(30, "PBR(배)");
        rowIndexTermMap.putIfAbsent(31, "현금DPS(원)");
        rowIndexTermMap.putIfAbsent(32, "현금배당수익률");
        rowIndexTermMap.putIfAbsent(33, "현금배당성향(%)");
        rowIndexTermMap.putIfAbsent(34, "발행주식수(보통주)");
    }
